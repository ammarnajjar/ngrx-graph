...
running command...
$ ngrx-graph (--version)
ngrx-graph/0.0.1-alpha.5 darwin-arm64 node-v19.0.0
...
_See code: [dist/commands/graph/index.ts](https://github.com/ammarnajjar/ngrx-graph/blob/v0.0.1-alpha.5/dist/commands/graph/index.ts)_
